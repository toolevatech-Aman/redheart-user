    ...
    groups: [
      ...
      // ]},
      {
        ...
        items: [
          ...
          { label: 'New Born Baby',         url: '/flowers/new-born-baby' },
      ...
      },
      {
        heading: 'Cities',
        items: [
          { label: 'Flowers to Bangalore',  url: '/florist-near-me/bangalore' },
          { label: 'Flowers to Chennai',    url: '/florist-near-me/chennai' },
          { label: 'Flowers to Delhi',      url: '/florist-near-me/delhi' },
          { label: 'Flowers to Gurgaon',    url: '/florist-near-me/gurgaon' },
          { label: 'Flowers to Hyderabad',  url: '/florist-near-me/hyderabad' },
...

  {
    ...
    groups: [
      ...
      },
      {
        heading: 'Cities',
        items: [
          { label: 'Cakes to Bangalore',  url: '/order-cake-online/bangalore' },
          { label: 'Cakes to Chennai',    url: '/order-cake-online/chennai' },
          { label: 'Cakes to Delhi',      url: '/order-cake-online/delhi' },
          { label: 'Cakes to Gurgaon',    url: '/order-cake-online/gurgaon' },
          { label: 'Cakes to Hyderabad',  url: '/order-cake-online/hyderabad' },
    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: 'New Born Baby',       url: '/plants/new-born-baby' },
      ...
      },
      {
        heading: 'Cities',
        items: [
          { label: 'Plants to Bangalore',  url: '/plants-online/bangalore' },
          { label: 'Plants to Chennai',    url: '/plants-online/chennai' },
          { label: 'Plants to Delhi',      url: '/plants-online/delhi' },
          { label: 'Plants to Gurgaon',    url: '/plants-online/gurgaon' },
          { label: 'Plants to Hyderabad',  url: '/plants-online/hyderabad' },
